...
<html>
  ...
  <body>
  			...
  			<div class="span12">
				...
				<div id="event_edit_container">
					...
					<ul style="padding: 0 11px;">
						...
						<li>
							<label for="title">主题：</label><input type="text" name="title" style="height: 30px;" readonly value="空闲时间" />
						</li>
						<li>
							<label for="body">备注：</label><textarea name="body" style="resize: none;"></textarea>
						</li>
					</ul>
				</div>
	...
	<script	type="text/javascript">
		function saveIdleTimeCalendar() {
			console.log("Save idle time calendar.");
		}
		(function($) {
			$(function() {
